...
''' same as Individual but now includes updating probabilities when don't get to see players cards'''
class Individual1(Player):
    def __init__(self):
