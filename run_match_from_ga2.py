...
''' setup the probability of betting/calling from command line remaining variables '''
ga_array = []
...
directoryname = '/Users/Charlie/Google Drive/Poker/Results/GAvsOppMod/run2/' + str(gen_num) + '/' + str(ga_position)
